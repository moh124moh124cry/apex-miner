...
import { BookOpen, X, Zap, Users, ArrowUpCircle } from 'lucide-react';
  ...
  return (
    <>
      <button
        ...
        className="fixed left-3 top-1/2 -translate-y-1/2 z-40 p-3 rounded-full bg-slate-800/80 backdrop-blur-md border border-blue-500/30 shadow-[0_0_15px_rgba(59,130,246,0.2)] text-blue-400 hover:text-blue-300 hover:scale-110 hover:border-blue-400 transition-all duration-300"
